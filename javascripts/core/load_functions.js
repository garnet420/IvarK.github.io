...
function transformSaveToDecimal() {
  ...
  for (var tier = 1; tier <= 8; ++tier) {
    player[TIER_NAMES[tier] + "Cost"] = new Decimal(player[TIER_NAMES[tier] + "Cost"])
    player[TIER_NAMES[tier] + "Amount"] = new Decimal(player[TIER_NAMES[tier] + "Amount"])
    player[TIER_NAMES[tier] + "Pow"] = new Decimal(player[TIER_NAMES[tier] + "Pow"])
  }
  ...
  for (var tier = 1; tier <= 8; ++tier) {
    player["infinityDimension" + tier].amount = new Decimal(player["infinityDimension" + tier].amount)
    player["infinityDimension" + tier].cost = new Decimal(player["infinityDimension" + tier].cost)
    player["infinityDimension" + tier].power = new Decimal(player["infinityDimension" + tier].power)
  }
  for (var tier = 1; tier <= 8; ++tier) {
    player["timeDimension" + tier].amount = new Decimal(player["timeDimension" + tier].amount)
    player["timeDimension" + tier].cost = new Decimal(player["timeDimension" + tier].cost)
    player["timeDimension" + tier].power = new Decimal(player["timeDimension" + tier].power)
  }
